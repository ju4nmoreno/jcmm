...
const SCENE3D = {
  ...
  __createGeo: function __createGeo () {
    const geometry = new THREE.DodecahedronGeometry(10, 1)
    ...
    const geometry_ = new THREE.BoxGeometry(2, 0.5, 0.5)
  ...
  __createBox: function __createBox () {
    const geometryBox = new THREE.BoxGeometry(200, 60, 40)
...
const APP = {
  ...
  __init: function __init () {
    ...
    if (this.ctx) {
      ...
      //
      const btn__showInfo = this.ctx.querySelector('.js-btn__showInfo')
...
let tempAnima = false
const transitionsEvent = whichTransitionEvent()
